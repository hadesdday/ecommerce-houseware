...
<head>
    ...
    <title>Quản Lý Thông Tin Sản Phẩm | NLU</title>

    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    <link rel="shortcut icon" href="https://pic.onlinewebfonts.com/svg/img_239979.png">
        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="sanpham.jsp"><i class="ti-desktop"></i> Sản phẩm</a>
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <button id="addBtn" type="button" class="btn btn-primary">Thêm thông tin sản phẩm</button>
                    <!--modal them hoa don-->

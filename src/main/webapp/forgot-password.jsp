                ...
                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
                    ...
                    <form action="${pageContext.request.contextPath}/forgotPassword" method="post">
                        <div class="forgot-password-form">
                            <h4 class="forgot-password-title text-center">Quên Mật Khẩu</h4>
                            <p>Vui lòng nhập username/email của bạn</p>
                            <div class="row">
                                <div class="col-md-12 col-12 mb-20">
                                    <input class="mb-0 rounded" type="text" placeholder="Email"
                                           id="email__account" name="username">
                                </div>
                                <div class="col-md-12 mt-3">
                                    <button type="submit" class="verify-button mt-0 w-100">Xác
                                        nhận
                                    </button>
                                </div>

                                ...
                                <div class="product-area shop-product-area">
                                    ...
                                    <div class="row product-list">
                                        <%
                                            if (products.size() < 1) {
                                        %>
                                        <%="<div class=\"none-product\">Không còn sản phẩm</div>" %>
                                        <%
                                        } else {
                                        %>
                            ...
                            <div class="paginatoin-area">
                                <div class="row paging">
                                    <div class="col-lg-6 col-md-6 pt-xs-15">
                                        <p>
                                            Showing <%=(((int) request.getAttribute("page")) * 5 - 4 + "-" + (((int) request.getAttribute("page")) * 5 > allProducts.size() ? allProducts.size() : ((int) request.getAttribute("page")) * 5))%>
                                            of <%=allProducts.size()%> items</p>
                                    </div>

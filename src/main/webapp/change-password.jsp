                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                    <form action="${pageContext.request.contextPath}/resetPassword" method="post">
                        <div class="change-password-form">
                            ...
                            <c:if test="${requestScope.changeSuccess.length() > 1}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <c:if test="${requestScope.newPassErr.length() > 1}">
                                        <label class="error__label">${requestScope.newPassErr}</label>
                                    </c:if>
                                </div>
                                <div class="col-md-12 mb-20">
                                    ...
                                    <c:if test="${requestScope.confirmPassErr.length() > 1}">
                                        <label class="error__label">${requestScope.confirmPassErr}</label>
                                    </c:if>
                                </div>
                                <div class="col-12">

...
<%
    ...
    String unameErr = (String) request.getAttribute("userError");
    String passErr = (String) request.getAttribute("passError");
    String rePassErr = (String) request.getAttribute("rePasswordErr");
    String emailErr = (String) request.getAttribute("emailError");
    String phoneErr = (String) request.getAttribute("phoneError");
%>
<!doctype html>
                        ...
                        <div class="register-form">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-20">
                                    ...
                                    <label class="error__label"><%=unameErr != null ? unameErr : ""%>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <input class="mb-0 rounded" type="password"
                                           ...
                                           name="password">
                                    <label class="error__label"><%=passErr != null ? passErr : ""%>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <label class="error__label"><%=rePassErr != null ? rePassErr : ""%>
                                    </label>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <input class="mb-0 rounded" type="text" placeholder="Họ Tên" id="fullname"
                                           name="fullname" value="<%=fullname != null ? fullname :""%>">
                                </div>
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <label class="error__label"><%=emailErr != null ? emailErr : ""%>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <label class="error__label"><%=phoneErr != null ? phoneErr : ""%>
                                    </label>
                                </div>

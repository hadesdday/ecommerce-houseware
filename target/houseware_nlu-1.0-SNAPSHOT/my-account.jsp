...
<%
    ...
    String phoneNumber = sessionUser.getPhone();
                            ...
                            <ul class="hm-menu">
                                ...
                                <li class="hm-minicart">
                                    ...
                                    <div class="minicart">
                                        ...
                                        <p class="minicart-total">Tổng cộng: <span>240000VNĐ</span></p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                            <div class="li-shipping-inner-box">
                                ...
                                <div class="shipping-text">
                                    ...
                                    <p>Chúng tôi đảm bảo an toàn tuyệt đối cho quý khách từ khâu mua hàng cho
                                        đến
                                        khâu vận chuyển.</p>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="copyright text-center pt-25">
                            <span>© 2021 Group 23. Tất cả các quyền được bảo lưu.</span>
                        </div>
...
<script>
    $("input[name='fullName']").on("input", () => {
        var s = $("input[name='fullName']").val();
        $("input[name='fullName']").attr('value', s);
    })
    $("input[name='address']").on("input", () => {
        var s = $("input[name='address']").val();
        $("input[name='address']").attr('value', s);
    })
    $("input[name='phoneNumber']").on("input", () => {
        var s = $("input[name='phoneNumber']").val();
        $("input[name='phoneNumber']").attr('value', s);
    })
    $("input[name='email']").on("input", () => {
        var s = $("input[name='email']").val();
        $("input[name='email']").attr('value', s);
    })
</script>
<script>
